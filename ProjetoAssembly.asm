...
; INTEGRANTES: TOBIAS FREIRE, EVERTON EMANUEL LLARENA, GUILHERME FREITAS
...
; EXPLICAÇÃO DE FUNÇÕES NÃO EXPLICADAS EM SALA
; MOVZX - SERVE PARA MOVER CONTEÚDO DE UM ESPAÇO DE DADOS MENOR PARA UM MAIOR
...
criptografar_prepare:
    ...
    ; Limpeza da chave
mov ecx, 0
mov esi, offset chaveDWORD
limpar_chave1:
    cmp ecx, 8
    je fim_limpar_chave1
