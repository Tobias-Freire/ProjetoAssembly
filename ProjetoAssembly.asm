...
criptografar:
    ...
    loopinho:
        ...
        resto2:
        invoke ReadFile, entradaHandle, addr entradaBuffer, 8, addr bytesLidos, NULL
        mov eax, bytesLidos
        test eax, eax
        jz fechar       
        ...
        ; Criptografa
        mov esi, offset entradaBuffer
        mov edi, offset saidaBuffer
        mov edx, offset chaveDWORD
        xor ecx, ecx
        cripto_loop:
            cmp ecx, 8
            je escrever
        ...
        escrever:          
            invoke WriteFile, saidaHandle, addr saidaBuffer, 8, addr bytesEscritos, NULL
            jmp loopinho
